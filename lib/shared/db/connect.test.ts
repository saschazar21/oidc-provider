...
describe('MongoDB Connection', () => {
  ...
  it('should include user, pass when NODE_ENV != test', async () => {
    ...
    const { config } = await import('~/lib/shared/db/connect');
  ...
  it('connects', async () => {
    ...
    const { default: connect } = await import('~/lib/shared/db/connect');
...
describe('MongoDB Configuration', () => {
  ...
  it('returns valid configuration object', async () => {
    ...
    const { default: connectionDetails } = await import('~/lib/shared/config/db');
